...
function main() {
  ...
  draw(gl, vao, n, loc_uProjMatrix, projMatrix, nf);   // Draw the triangles
}
...
function keydown(ev, gl, vao, n, u_ProjMatrix, projMatrix, nf) {
  switch(ev.keyCode){
  ...
  draw(gl, vao, n, u_ProjMatrix, projMatrix, nf);    
}
