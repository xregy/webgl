...
out vec4 fColor;
void main() {
  fColor = vec4(gl_FragCoord.z, 0.0, 0.0, 0.0); // Write the z-value in R
}`;
...
function main() {
  ...
  if (normalProgram.loc_aPosition < 0 || normalProgram.aColor < 0 || !normalProgram.loc_uMvpMatrix ||
      !normalProgram.loc_uMvpMatrixFromLight || !normalProgram.uShadowMap) {
