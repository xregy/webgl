...
function main() {
  ...
  gl.uniform1i(loc_uClicked, 0); // Pass false to loc_uClicked
...
function initVertexBuffers(gl) {
  ...
  if (!initArrayBuffer(gl, vertices, gl.FLOAT, 3, loc_aPosition)) return -1; // Coordinate Information
...
function check(gl, vao, n, x, y, currentAngle, loc_uClicked, viewProjMatrix, loc_uMvpMatrix) {
  let picked = false;
  gl.uniform1i(loc_uClicked, 1);  // Pass true to u_Clicked
  draw(gl, vao, n, currentAngle, viewProjMatrix, loc_uMvpMatrix); // Draw cube with red
  ...
  gl.uniform1i(loc_uClicked, 0);  // Pass false to uClicked(rewrite the cube)
  draw(gl, vao, n, currentAngle, viewProjMatrix, loc_uMvpMatrix); // Draw the cube
